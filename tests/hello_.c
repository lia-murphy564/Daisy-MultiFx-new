...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_hello_(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_hello_(void) { return NULL; }
#  else
     inithello_(void) { }
#  endif
#  endif
...
PyInit_hello_(void)
{
  return _cffi_init("hello_", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inithello_(void)
{
  _cffi_init("hello_", 0x2601, &_cffi_type_context);
}
#endif
